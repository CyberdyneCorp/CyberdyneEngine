...
So the order is specified too, in twenty rungs with no dates — because a date is an estimate that
decays, while *after what* is a design consequence that does not. Twenty and not twelve because the
ladder has been split four times and never renumbered: M5.5 was inserted, M8 became M8.a, M8.b and
M8.c, M11 became M11.a through M11.e, and M11.d's spike inserted M11.d.5 · Backends — Metal and
D3D12, neither of which compiles on the Linux host this project works on.
...
| **Shipping** | M9 Integrity · M10 Worlds · M11.a Foundations · M11.b Authoring · M11.c Image · M11.d Desktop · M11.d.5 Backends · M11.e Ship | Four-player rollback, open worlds, a game made in the editor, every platform — 1.0 |
...
saving with `Ctrl+S`. The live viewport draws the cooked mesh with its full transform. Imported
material factors are shown; sampled FBX textures in the Metal frame are still being connected.
