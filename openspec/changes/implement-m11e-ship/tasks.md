...
- [x] 6.1a **`navigation` AND `physics` ARE SWEPT FIRST, AND THEY ARE NAMED HERE BECAUSE THE GAME
      ...
      - [x] The rows are on the critical path of the RTS this engine is about to be used for:
      ...
      - [x] **`physics`' fixed-step integration is load-bearing for lockstep determinism.** An RTS
      ...
      - [x] **Expect mappings that do not observe their requirement.** M11.c mutation-tested 27 of its
