...
Menus, toolbars, context menus, keyboard shortcuts, the command palette, automation, tests, and future
assistive tooling SHALL all invoke commands. An action reachable only through a specific widget SHALL
be a defect.
