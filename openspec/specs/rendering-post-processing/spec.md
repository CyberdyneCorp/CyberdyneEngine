...
resolution, spatially filtered and temporally accumulated.
...
**Temporal reprojection** with per-frame jitter SHALL be used so the low-resolution volume
converges without visible noise.
