...
The SDF SHALL be sampleable from 2D materials and used by 2D particle collision and soft shadow
effects.

#### Scenario: Particle collides with 2D geometry
- **WHEN** a 2D particle system enables SDF collision
- **THEN** particles SHALL collide with occluder geometry sampled from the SDF
