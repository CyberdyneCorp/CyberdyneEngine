...
| Job workers | Parallel system execution, culling, animation sampling, asset decode, physics jobs |
| Render | Render graph recording and GPU submission; owns all RHI objects |
| Audio | Audio mixing and effect processing; owns playback state |
