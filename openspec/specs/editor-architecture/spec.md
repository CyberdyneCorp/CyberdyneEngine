...
animation graphs and clips (a timeline with curve editing), particle systems, terrain and
tilemaps, UI layout, audio buses and mixing, navigation baking, lighting and lightmap baking, and
localisation tables.
