...
Decals SHALL support: angle-based fade against the receiving surface normal, distance fade,
a sort order, a layer mask, and normal blending that preserves the receiver's detail.
