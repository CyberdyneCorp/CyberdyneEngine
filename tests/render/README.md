...
| off, or under a clear sky | the placeholder binding, the field bound and off, the clear field bound and off, and the clear field bound and ON all give the same frame bit for bit — and the cloudy field on does not |
