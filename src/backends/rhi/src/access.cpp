...
constexpr AccessInfo kAccessTable[kAccessCount] = {
    ...
    // --- Graphics ------------------------------------------------------------------------------
    {Stage::VertexInput, AccessFlags::VertexAttributeRead, ImageUse::Undefined, false, false, true,
     "VertexAttributeRead"},
    {Stage::VertexInput, AccessFlags::IndexRead, ImageUse::Undefined, false, false, true,
     "IndexRead"},
    {Stage::DrawIndirect, AccessFlags::IndirectCommandRead, ImageUse::Undefined, false, false, true,
     "IndirectCommandRead"},
    ...
    {Stage::FragmentShader, AccessFlags::UniformRead, ImageUse::Undefined, false, false, true,
     "FragmentUniformRead"},
    {Stage::FragmentShader, AccessFlags::ShaderSampledRead, ImageUse::SampledRead, false, true,
     false, "FragmentSampledRead"},
