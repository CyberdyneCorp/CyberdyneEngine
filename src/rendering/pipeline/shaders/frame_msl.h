...
#line 231
[[vertex]] cyDepthVertex_Result_0 cyDepthVertex(vertexInput_0 _S3 [[stage_in]], CyDrawPush_0 constant* cyDraw_1 [[buffer(7)]], CyDrawInstance_0 device* cyDrawInstances_1 [[buffer(4)]], CyInstanceTransform_0 device* cyInstances_1 [[buffer(5)]], CyFrameData_0 constant* cyFrame_1 [[buffer(0)]])
{
...
#line 241
    thread CyInstanceTransform_0 _S4 = cyInstances_1[cyDrawInstances_1[cyDraw_1->drawIndex_0].instanceSlot_0];
...
#line 242
    thread cyDepthVertex_Result_0 _S7;
...
/// depth_fragment.metal, 229 bytes.
...
[[fragment]] void cyDepthFragment(float4 position_0 [[position]])
{
...
/// forward_vertex.metal, 5303 bytes.
...
#line 188 "src/rendering/shaders/cy/frame.slang"
...
/// forward_fragment.metal, 14729 bytes.
...
#line 194 "src/rendering/shaders/cy/frame.slang"
...
#line 289 "src/rendering/shaders/cy/frame.slang"
...
/// resolve_vertex.metal, 884 bytes.
inline constexpr char kFrameResolveVertexMsl[] = R"cy_msl(#include <metal_stdlib>
#include <metal_math>
#include <metal_texture>
using namespace metal;

#line 47 "src/rendering/shaders/cy/fullscreen.slang"
...
/// resolve_fragment.metal, 3452 bytes.
...
#line 85 "src/rendering/shaders/cy/fullscreen.slang"
...
#line 15 "src/rendering/shaders/cy/fullscreen.slang"
...
#line 109
    if(((&kernelContext_0)->viewSet_0->frame_0->rows_0[int(9)].x) < 0.0)
    {
