...
**What D3D12 needs.** The four fragment entry points compile to HLSL and to DXIL
(`slangc -target dxil -profile sm_6_0`, run by hand; nothing embeds the result yet). The vertex
stage is the frame's own `fullscreenVertex`, which DXC refuses
