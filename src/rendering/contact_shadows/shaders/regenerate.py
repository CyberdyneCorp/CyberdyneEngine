...
"""Recompile contact_shadows.slang and rewrite the two committed headers.
...
one a Development build stages at <build>/Development/bin/slangc.
    ...
    python3 src/rendering/contact_shadows/shaders/regenerate.py --slangc build/dev/Development/bin/slangc

src/rendering/occlusion/shaders/regenerate.py is the same script for that module's two dispatches.
...
MODULES = (("contact_shadows", "cyContactShadows", "kContactShadowsSpirv", "kContactShadowsMsl"),)
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as scratch:
        ...
        spirv_header = HERE.parent / "src" / "contact_spirv.h"
        msl_header = HERE.parent / "src" / "contact_msl.h"
