// src/core/config/ — scaffold placeholder. Delete this file and src/placeholder.cpp when the
...
// <cy/core/config/placeholder.h>, so a wrong PUBLIC_INCLUDE_DIRS is a compile error at the moment
...
void config_scaffold_placeholder();
