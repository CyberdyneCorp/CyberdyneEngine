...
//! engine's table — so an SDK generated against 1.2 works against any 1.x engine with
//! x >= 2, and is refused by an older one rather than reading a short table.
//!
