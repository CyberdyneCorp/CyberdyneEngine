...
# Where a barrier may be emitted: the interface that declares it, each native RHI implementation
# that reaches it, and — from M7 — the viewport transport's publisher.
#
